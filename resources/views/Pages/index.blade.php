...
<head>
    ...
    <link href="{{ asset('Indsutrio') }}/lib/animate/animate.min.css" rel="stylesheet">
    <link href="{{ asset('Indsutrio') }}/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="{{ asset('Indsutrio') }}/css/bootstrap.min.css" rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="{{ asset('Indsutrio') }}/css/style.css" rel="stylesheet">
</head>
...
<body>
    ...
    <script src="{{ asset('Indsutrio') }}/lib/wow/wow.min.js"></script>
    <script src="{{ asset('Indsutrio') }}/lib/easing/easing.min.js"></script>
    <script src="{{ asset('Indsutrio') }}/lib/waypoints/waypoints.min.js"></script>
    <script src="{{ asset('Indsutrio') }}/lib/owlcarousel/owl.carousel.min.js"></script>
    <script src="{{ asset('Indsutrio') }}/lib/counterup/counterup.min.js"></script>

    <!-- Template Javascript -->
    <script src="{{ asset('Indsutrio') }}/js/main.js"></script>
</body>
